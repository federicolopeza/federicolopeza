...
def main():
    ...
    t.gen_text(
        f"Copyright (C) {year_now}, "
        "\x1b[32mPentagoo Labs Inc.\x1b[0m",
        2,
    )
    ...
    \x1b[32mHost:\x1b[0m     AutoP2P / Pentagoo Labs
    \x1b[32mKernel:\x1b[0m   Full Stack Engineer
    ...
    t.toggle_show_cursor(True)
    t.gen_typing_text(
        "\x1b[32m# build > hype\x1b[0m", t.curr_row, contin=True
    )
